...
import 'package:kyure/presentation/pages/account_list/extensions/account_list_extensions.dart';
                  ...
                  case SyncResultType.success:
                    BotToast.showCustomText(
                        toastBuilder: (cancelFunc) => ToastWidgetMolecule(
                            ...
                            textStyle:
                                TextStyle(color: kyTheme.colorToastText)));
                    break;
          ...
          Positioned(
              ...
              child: BluredBottomAppBarMolecule(items: [
                ...
                BottomItemActionMolecule(
                    ...
                    onTap: () async {
                      final saved =
                          await context.pushNamed(KyRoutes.groupEditor.name);
